    ...
    try {
      ...
      if(os.platform() == 'darwin') {
        ...
        if(browser.toLowerCase().indexOf('\\chrome.exe') != -1) {
          ...
          fs.writeFileSync(path.join(os.homedir(), 'Open e-ID.html'), '<html><head><!-- saved from url=(0014)about:internet --><title>Open e-ID</title></head><body onload="window.open(\'http://www.google.be\', \'' + ((wname == '') ? '_self' : wname) + '\');"></body></html>');
